...
class OriAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if(convertView==null){
                convertView=View.inflate(context, R.layout.ori_item1,null);
                viewHoudler = new ViewHoudler();
                viewHoudler.imageView= (ImageView) convertView.findViewById(R.id.ori_img1);
                viewHoudler.textView= (TextView) convertView.findViewById(R.id.ori_text);
                viewHoudler.textView1= (TextView) convertView.findViewById(R.id.ori_text1);
                viewHoudler.textView2= (TextView) convertView.findViewById(R.id.ori_text3);
