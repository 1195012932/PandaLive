...
class TopAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView==null){
            convertView=View.inflate(context, R.layout.top_item1,null);
            viewHoudler = new ViewHoudler();
            viewHoudler.imageView= (ImageView) convertView.findViewById(R.id.top_img1);
            viewHoudler.textView= (TextView) convertView.findViewById(R.id.top_text);
            viewHoudler.textView1= (TextView) convertView.findViewById(R.id.top_text1);
            viewHoudler.textView2= (TextView) convertView.findViewById(R.id.top_text3);
