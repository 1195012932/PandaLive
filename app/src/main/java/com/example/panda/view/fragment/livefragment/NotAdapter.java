...
class NotAdapter extends BaseAdapter{
    ...
    public NotAdapter(Context context, List<NotBean.VideoBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView==null){
            convertView=View.inflate(context, R.layout.not_item1,null);
            viewHoudler = new ViewHoudler();
            viewHoudler.imageView= (ImageView) convertView.findViewById(R.id.not_img1);
            viewHoudler.textView= (TextView) convertView.findViewById(R.id.not_text);
            viewHoudler.textView1= (TextView) convertView.findViewById(R.id.not_text1);
            viewHoudler.textView2= (TextView) convertView.findViewById(R.id.not_text3);
