...
/**
 * Created by XXASUS on 2017/7/19.
 */

public class OkHttpsManner {


    private volatile static OkHttpsManner utills;
    private OkHttpClient client;
    private Handler handler;

    //单例保证该方法执行后只能在同一时间使用同一个对象
    public static synchronized OkHttpsManner getInstance() {
        if (utills == null) {
            utills = new OkHttpsManner();
        }
        return utills;
    }

    //构造方法
    public OkHttpsManner() {
